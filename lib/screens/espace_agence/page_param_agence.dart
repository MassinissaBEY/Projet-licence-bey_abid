...
class page_parametres_agence extends StatefulWidget {
  const page_parametres_agence({Key key}) : super(key: key);

  @override
  State<page_parametres_agence> createState() => _page_parametres_agenceState();
}

class _page_parametres_agenceState extends State<page_parametres_agence> {
   void initState() {
    super.initState();
